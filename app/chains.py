...
class Chain:
    ...
    def write_mail(self, job, links):
        prompt_email = PromptTemplate.from_template(
            ...
            Provide Contact Details: Conclude the email with the department's official contact details, including the email ID is statisticspg@rjcollege.edu.in and phone number is 9321814363 in 'Regard' section.
